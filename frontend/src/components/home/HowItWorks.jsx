...
const STEPS = [
  {
    ...
    glow: '#7C8FF433',
    iconBg: '#E9F0FF',
    titleEN: 'Pick Your Profile',
    titleBN: 'প্রোফাইল বেছে নিন',
    subEN: 'Solo, Couple, or Family',
    subBN: 'একা, দম্পতি বা পরিবার',
  },
  {
    icon: aucklandSvg,
    borderColor: '#2FB9B1',
    glow: '#2FB9B133',
    iconBg: '#E7F8F6',
    titleEN: 'Choose a City',
    titleBN: 'শহর বেছে নিন',
    subEN: 'Auckland, Wellington & more',
    subBN: 'অকল্যান্ড, ওয়েলিংটন ও আরও',
  },
  {
  ...
  },
  {
    ...
    glow: '#4BAEEA33',
    iconBg: '#EAF6FF',
    titleEN: 'Set Living Fund',
    titleBN: 'লিভিং ফান্ড দিন',
    subEN: 'Survival window calc',
    subBN: 'কতদিন টিকবে জানুন',
  },
  {
    ...
    glow: '#D86FA133',
    iconBg: '#FCEAF4',
    titleEN: 'Track Readiness',
    titleBN: 'প্রস্তুতি ট্র্যাক করুন',
